...
export type CreateIngredientForDrinkType = Omit<
  definitions["ingredient_for_drink"],
  "id"
>;

export type UpdateIngredientForDrinkType = definitions["ingredient_for_drink"];
